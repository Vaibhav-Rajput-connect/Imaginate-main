...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[610px] mx-auto mt-10 text-center'
        initial={{opacity:0}}
        animate={{opacity:1}}
        ...
        >Imaginate transforms simple text into high-quality images using advanced AI, empowering anyone to visualize ideas creatively and instantly.</motion.p>
        ...
        >
            {Array(6).fill('').map((item, index)=>(
                ...
                whileHover={{scale:1.05, duration: 0.1}} src={index % 2 === 0 ? assets.sample_img_2 : assets.sample_img_1} alt='' key={index} width ={70} />
            ))}
        </motion.div>
        <motion.p
        initial={{opacity:0}}
